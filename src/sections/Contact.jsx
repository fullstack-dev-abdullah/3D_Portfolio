  ...
  return (
    <section id="contact" className="flex-center section-padding">
      <div className="w-full h-full md:px-10 px-5">
        ...
        />
        <div className="grid-12-cols mt-16 gap-5 xl:gap-5">
...
<div className="relative h-[50vh] sm:h-[40vh] md:h-[70vh] xl:h-[76vh] overflow-hidden">
                <img
                  src="/images/hero.jpg"
                  alt="Contact visual"
                ...
                <div className="max-w-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <a
                        href={`mailto:${import.meta.env.VITE_APP_PERSONAL_MAIL}`}
